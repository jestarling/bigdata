...
sgd_adagrad <- function(X,Y,m,step=.01,maxiter=50000,conv=1E-10){
...
#output <- sgd_adagrad(X,Y,m,step=5,maxiter=1000000,conv=1E-10)
output <- sgd_adagrad(X,Y,m,step=10,maxiter=1000000,conv=1E-10)
